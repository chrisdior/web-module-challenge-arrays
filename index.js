...
function is31Flavors(originalFlavors){
   ...
   var flavorsCount = originalFlavors

   if (flavorsCount === 31){
       console.log("true")
   }
   else(flavorsCount > 31)
      console.log("false")
   

}
is31Flavors(17)// Returning 32?? Why?
...
function addFlavor(newFlavor,originalFlavors){
    let add=originalFlavors.unshift(newFlavor);
    return add;
}
addFlavor("Watermelon Whirlpool",originalFlavors);
...
console.log(originalFlavors); //Won't remove last flavor.
...
return originalFlavors.slice(2);
}
